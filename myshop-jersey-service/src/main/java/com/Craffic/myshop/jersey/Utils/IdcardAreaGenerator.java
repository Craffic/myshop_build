...
public class IdcardAreaGenerator {

    @Autowired
    IdcardAreaDao areaDao;

    /**
     * 姓名生成器
     * @return
     */
    public static HashMap<String, Integer> getAreaMap(){

        HashMap<String, Integer> areaCode = new HashMap<String, Integer>();
